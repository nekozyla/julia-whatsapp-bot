// src/managers/sessionManager.js (Caminhos Corrigidos)
const fs = require('fs').promises;
const path = require('path');
const { SESSIONS_DIR, JULIA_INITIAL_GREETING, DEFAULT_MAX_OUTPUT_TOKENS } = require('../../config/config.js');
const { textModel } = require('./geminiClient.js'); 
const settingsManager = require('./groupSettingsManager.js'); 
const personalities = require('../../config/personalities.js'); 
